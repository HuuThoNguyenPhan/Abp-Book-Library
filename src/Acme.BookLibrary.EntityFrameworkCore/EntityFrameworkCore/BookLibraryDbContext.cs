...
public class BookLibraryDbContext :
    AbpDbContext<BookLibraryDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(BookLibraryConsts.DbTablePrefix + "Books",
                BookLibraryConsts.DbSchema);
        ...
        {
            b.ToTable(BookLibraryConsts.DbTablePrefix + "Authors",
                BookLibraryConsts.DbSchema);
        ...
        {
            b.ToTable(BookLibraryConsts.DbTablePrefix + "MemberCards",
                BookLibraryConsts.DbSchema);
            b.ConfigureByConvention();
        });
        ...
        {
            b.ToTable(BookLibraryConsts.DbTablePrefix + "Checkouts",
                BookLibraryConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasOne<MemberCard>().WithMany().HasForeignKey(x => x.CardId).IsRequired();
        });

        builder.Entity<CheckoutDetail>(b =>
        {
            b.ToTable(BookLibraryConsts.DbTablePrefix + "CheckoutDetails",
                BookLibraryConsts.DbSchema);
            b.ConfigureByConvention();
            b.HasOne<Checkout>().WithMany().HasForeignKey(x => x.CheckoutId).IsRequired();
